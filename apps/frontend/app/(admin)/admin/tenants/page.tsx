  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <h1 className="mt-2 text-2xl font-semibold text-slate-900">Create a tenant</h1>
        <p className="mt-2 text-sm text-slate-500">
          Add tenant branding and connect their first domain.
        </p>
      </div>
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <div className="grid gap-4 md:grid-cols-2">
          <div>
            <label className="text-xs font-semibold text-slate-500">Tenant name</label>
            <input
        ...
        <div className="mt-6 flex items-center justify-between">
          <p className="text-xs text-slate-500">
            The tenant will be linked to this domain automatically.
          </p>
          <button
            ...
            <table className="w-full border-collapse text-left text-sm">
              <thead>
                <tr className="border-b border-slate-200 text-xs uppercase tracking-wide text-slate-500">
                  ...
                  <th className="py-3 pr-4">Support Email</th>
